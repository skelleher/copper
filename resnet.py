...
# This is a Resnet50 model that has the classifier layer removed
# The output vectors are suitable for image search or captioning.
...
# This is a Resnet50 model that has the classifier layer removed
# Unlike a classic Resnet50, the final fully-connected layer has 512 units instead of 2048.
# The output vectors are suitable for image search or captioning; the length of 512 is friendlier for kNN search.

class Resnet50CBIR_512( nn.Module ):
    def __init__( self, input_width = 224, input_height = 224 ):
        super( Resnet50CBIR_512, self ).__init__()
